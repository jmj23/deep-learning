...
if redo==0:
    ...
    SegModel = Kmodels.BlockModel_v1(x_train)
...
time1 = time.time()
scores = SegModel.evaluate(x_test,y_test,batch_size=16)
time2 = time.time()
