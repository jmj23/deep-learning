...
#    curr_img1 -= mean_img1
#    curr_img1 /= std_img1
    curr_img1 -= np.min(curr_img1)
    curr_img1 /= np.max(curr_img1)
        
    img1 = curr_img1[np.newaxis,...,np.newaxis]
    img2 = curr_img2[np.newaxis,...,np.newaxis]
...
score = RegModel.evaluate(x_val,y_val,batch_size=4)
print("")
