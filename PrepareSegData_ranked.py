...
# store validation data to HDF5 file
print('storing validation data as HDF5')
with h5py.File('segdata_ranked_val.hdf5', 'x') as hf:
    hf.create_dataset("inputs",  data=val_inputs,dtype='f')
with h5py.File('segdata_ranked_val.hdf5', 'a') as hf:
...
with h5py.File('segdata_ranked_train.hdf5', 'x') as hf:
    hf.create_dataset("inputs",  data=aug_inputs,dtype='f')
with h5py.File('segdata_ranked_train.hdf5', 'a') as hf:
