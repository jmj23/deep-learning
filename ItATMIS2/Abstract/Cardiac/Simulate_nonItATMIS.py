...
model_weights_path = '/home/jmj136/deep-learning/ItATMIS2/Abstract/Cardiac/best_model_weights2.h5'
val_frac = 0.2
num_CV_folds = 10
...
for it in range(num_CV_folds):
    ...
    results_path = '/home/jmj136/deep-learning/ItATMIS2/Abstract/Results/NonItATMIS_SimResults_{}_CV{}.txt'.format('Cardiac',it+1)
